...
import { Award, CalendarDays, Users, Flame, TrendingUp, Eye, Heart, AlertTriangle } from 'lucide-react'
...
export default function HomeClient({
  ...
  friendReviews, popularGames, userId,
}: Props) {
  ...
  useEffect(() => {
    fetch('/api/games/releases')
      ...
      .catch(() => {
        setWeeklyError('Impossible de charger les sorties de la semaine.')
        setWeeklyGames([])
      })
